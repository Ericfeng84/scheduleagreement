// src/main/java/com/example/scheduleagreement/exception/GlobalExceptionHandler.java
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> illegalStateException(IllegalStateException ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(), ex.getMessage(), request.getDescription(false));
        return new ResponseEntity<>(errorDetails, HttpStatus.CONFLICT); // Or BAD_REQUEST depending on context
    }
